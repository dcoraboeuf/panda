...
public interface SQL {
    ...
    // Instances
    String INSTANCE_CREATE = "INSERT INTO INSTANCE (PIPELINE, PARAMETERS, STATUS, RESULT) VALUES (:pipeline, :parameters, 'STARTED', 'NONE')";
    String INSTANCE_STARTED = "SELECT * FROM INSTANCE WHERE STATUS = 'STARTED'";
}
