...
import net.panda.service.security.*;
...
@Component
public class PandaDecisionManager implements AccessDecisionManager {

    private final Logger logger = LoggerFactory.getLogger(PandaDecisionManager.class);
    private final SecurityUtils securityUtils;

    @Autowired
    public PandaDecisionManager(SecurityUtils securityUtils) {
