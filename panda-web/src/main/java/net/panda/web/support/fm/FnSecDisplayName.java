...
public class FnSecDisplayName implements TemplateMethodModel {

    private final SecurityUtils securityUtils;

    @Autowired
    public FnSecDisplayName(SecurityUtils securityUtils) {
    ...
    public Object exec(@SuppressWarnings("rawtypes") List list)
        ...
        // Test
        return securityUtils.getCurrentAccount().getFullName();
    }
